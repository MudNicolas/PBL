        ...
        <div class="vicp-wrap">
            ...
            <div v-show="step == 1" class="vicp-step1">
                ...
                >
                    ...
                    <span v-show="loading !== 1" class="vicp-hint">{{ tip }}</span>
                ...
                <div class="vicp-crop">
                    <div v-show="true" class="vicp-crop-left">
                        ...
                        <div v-if="!noRotate" class="vicp-rotate">
                            <i @click="RotateLeft" class="no-blue">↺</i>
                            <i @click="RotateRight" class="no-blue">↻</i>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        // 设置步骤
        setStep(no) {
            // 延时是为了显示动画效果呢，哈哈哈@去掉了延时-Nicolas
            this.step = no
        },
        /* 图片选择区域函数绑定
     ---------------------------------------------------------------*/
        ...
        // 上传图片
        upload() {
            const { lang, imgFormat, mime, params, field, ki, createImgUrl } = this
